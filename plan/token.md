# Plan is to create a tokenization of the property 

## Tokenization

### Tokenization of the property

this is how the type of the property will look like now i have to desing the anchor code for this 
...
so create a another md file having anchor logic and the code for the tokenization of the property 